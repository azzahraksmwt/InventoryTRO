...
<div class="mx-4 my-8">
    ...
    <form action="{{ route('usages.update_lecturer', $usage->idpb) }}" method="POST" class="no-select" id="usageForm">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('usages.index_validation_lecturer') }}" class="bg-slate-700 text-white px-4 py-2 rounded-md">Cancel</a>
