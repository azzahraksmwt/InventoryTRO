...
@section('container')
    <div class="mx-4 my-8">
        ...
        <div class="flex items-center justify-between mb-4">
            <form action="{{ route('reports.index_lecturer') }}" method="get" class="flex items-center space-x-2">
                @csrf
            ...
            <a href="{{ route('reports.cetak_lecturer') }}" class="bg-slate-700 text-white px-4 py-2 rounded-md">Cetak</a>
        </div>        
