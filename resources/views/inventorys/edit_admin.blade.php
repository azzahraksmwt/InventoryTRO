...
<div class="mx-4 my-8">
    ...
    <form action="{{ route('inventorys.update_admin', $inventoryItem->idbarang) }}" method="POST" class="no-select" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <div class="flex items-center">
                <span> value="{{ $inventoryItem->foto }}"</span>
